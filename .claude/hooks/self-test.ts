...
// Determine PAI_DIR from this script's location
// This script lives in PAI/.claude/hooks/, so go up two levels to get PAI root
const SCRIPT_DIR = import.meta.dir;  // Bun-specific: directory containing this script
const PAI_DIR = resolve(SCRIPT_DIR, '..');  // Go up from hooks/ to .claude/
const REPO_ROOT = resolve(PAI_DIR, '..');   // Go up from .claude/ to PAI root
