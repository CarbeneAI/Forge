...
const PREDEFINED_THEMES: Record<ThemeName, PredefinedTheme> = {
  ...
  'carbeneai': {
    name: 'carbeneai',
    displayName: 'CarbeneAI',
    description: 'Corporate branding theme with electric cyan and vivid purple accents',
    cssClass: 'theme-carbeneai',
    preview: { primary: '#0a0a12', secondary: '#1a1a2e', accent: '#00d4ff' },
    colors: {
      primary: '#00d4ff',
      primaryHover: '#00b8e6',
      primaryLight: '#1a3a4d',
      ...
      borderSecondary: 'rgba(0, 212, 255, 0.3)',
      borderTertiary: 'rgba(0, 212, 255, 0.4)',
      accentSuccess: '#34d399',
      accentWarning: '#fbbf24',
      accentError: '#f87171',
      accentInfo: '#00d4ff',
...
export function useThemes() {
  ...
  const initializeTheme = () => {
    ...
    if (savedTheme) {
      ...
      // Default to CarbeneAI theme for corporate branding
      setTheme('carbeneai');
    }
  };
