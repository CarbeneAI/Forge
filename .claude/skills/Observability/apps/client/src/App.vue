<template>
  <div class="compact-mode h-screen flex flex-col theme-carbeneai dashboard-modern">
    <!-- Background gradient overlay - CarbeneAI branded -->
    <div class="fixed inset-0 bg-gradient-to-br from-[#0a0a12] via-[#12122a] to-[#0a0a12] -z-10"></div>
    ...
    <!-- CarbeneAI Branding Watermark -->
    <div class="fixed bottom-4 left-4 z-50 pointer-events-none">
      <span class="carbeneai-brand">CARBENEAI</span>
    </div>
