...
- `[AGENT:engineer]` → Engineer completion handling
- `[AGENT:researcher]` → Researcher completion handling
- `[AGENT:pentester]` → Pentester completion handling
- etc.
...
- No `🎯 COMPLETED:` line → Capture may not trigger
